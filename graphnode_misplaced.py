...
#b.duplicate([4,1,3,7,2,5,0,8,6], b.dimension)  # very bad than linear conflict for this.
b.duplicate([4,1,3,2,0,5,7,8,6], b.dimension)  # better than linear conflict for this.
